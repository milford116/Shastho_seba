...
const options = {
	swaggerDefinition: {
		...
		openapi: "3.0.0",
		servers: [{url: "http://52.77.186.131:5000"}, {url: "https://52.77.186.131:5000"}, {url: "http://localhost:5000"}, {url: "https://localhost:5000"}],
		responses: {
			UnauthorizedError: {
	...
	apis: ["./models/*.js", "./controllers/doctor/*.js", "./controllers/patient/*.js"],
	explorer: true,
};
